...
ON CONFLICT (event_id) DO UPDATE SET
    ...
    raw_offset_id_list = concat_ws(',', excluded.raw_offset_id, cln.shipment_products.raw_offset_id_list),
    event_timestamp = excluded.event_timestamp,
    event_name = excluded.event_name,
    meta_update_timestamp = NOW(),
    meta_source_file_path = excluded.meta_source_file_path,
    meta_source_file_path_list = concat_ws(',', excluded.meta_source_file_path, cln.shipment_products.meta_source_file_path)